...
export default function WhatWeAre() {
  return (
    <>
      <div className="w-[100%] md:px-[100px] px-[20px] py-2 flex justify-between lg:flex-row flex-col mt-[50px] border-t pt-[50px]">
        ...
        <div className="w-[100%] ">
          <p className="mb-3 text-gray-500 dark:text-gray-400 font-semibold">
