...
export default function DownloadApp() {
  return (
    <>
      <div className="w-[100%] lg:px-[100px]  bg-green-500 mt-[100px] rounded-[20px] gap-5 md:flex-row flex-col py-5 px-10 flex justify-between items-center">
        ...
        <div className="w-[100%]">
          <p className="text-[18px] text-gray-50">
            ...
            tablet, or watch. A mobile application or app is a computer program
            or software application designed to run on a mobile device such as a
